        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="text-right">
                    <button type="submit" class="btn btn-warning" id="btnPrPasswordEditSave" data-loading-text="<span class='spinner-border spinner-border-sm'></span> Guardando...">Guardar</button>
