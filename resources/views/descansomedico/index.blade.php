...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Personal Con Descansos Médicos Registrados</h3>
    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            ...
                            <div class="col-6">
                                <form action="{{route('descansosmedicos.export')}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col">
...
<script>
    $(document).ready(function() {
        ...
        $('#descansosmedicos').DataTable({
            ...
            "ajax": "{{route('tabla.descansosmedicos')}}",
            "columns": [
                // {data:'codigo_persona'},
                {
